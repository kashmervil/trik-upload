...
namespace Upload_Extension_UnitTests.MenuItemTests
{
    ...
    public class MenuItemTest
    {
        ...
        public void InitializeMenuCommand()
        {
            ...
            CommandID menuCommandID = new CommandID(Trik.Upload_Extension.GuidList.guidUpload_ExtensionCmdSet, (int)Trik.Upload_Extension.PkgCmdIDList.ConnectToTarget);
